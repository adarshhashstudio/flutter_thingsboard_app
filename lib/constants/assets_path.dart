abstract class ThingsboardImage {
  static final polwaxLogin = 'assets/images/polwax_blue.svg';
  static final thingsBoardWithTitle =
      'assets/images/polwax_white.svg'; // 'assets/images/thingsboard_with_title.svg';
  static final thingsboard =
      'assets/images/polwax_logo_white.png'; // 'assets/images/thingsboard.svg';
